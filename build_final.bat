...
echo Building %APP_NAME% with integrated server...
...
:: Rename the output to indicate it's the server version
if exist "dist\%APP_NAME%.exe" (
    if not exist "dist\%APP_NAME%_with_server.exe" (
        ren "dist\%APP_NAME%.exe" "%APP_NAME%_with_server.exe"
    )
)

echo.
echo =========================================
echo Build complete with integrated server!
echo The standalone executable is available in the 'dist' folder as '%APP_NAME%_with_server.exe'
echo =========================================
pause
